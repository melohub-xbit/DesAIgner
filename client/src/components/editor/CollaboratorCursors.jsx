          ...
          return (
            ...
            >
              ...
              <div className="relative">
                {/* Glow effect */}
                <div
                  className="absolute -inset-2 blur-md opacity-60"
                  style={{
              ...
              {/* User label with glassmorphic effect */}
              <motion.div
                initial={{ opacity: 0, y: -5 }}
                animate={{ opacity: 1, y: 0 }}
                transition={{ delay: 0.1 }}
                className="mt-2 px-3 py-1.5 backdrop-blur-xl rounded-lg whitespace-nowrap shadow-2xl relative overflow-hidden border"
                style={{
                  background: `linear-gradient(135deg, hsl(${hue}, 70%, 50%, 0.9) 0%, hsl(${hue + 30}, 70%, 50%, 0.9) 100%)`,
                  borderColor: `hsl(${hue}, 70%, 70%, 0.3)`,
                  boxShadow: `0 4px 12px hsl(${hue}, 70%, 40%, 0.4)`,
                }}
              >
                {/* Shine effect */}
                <div
